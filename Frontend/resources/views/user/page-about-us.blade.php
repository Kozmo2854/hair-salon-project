        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="heading heading-2 mb-30 pt-50">
                    <h2 class="heading--title">Jovan Zejnula</h2>
                </div>
                <p>Backend software developer with 3 years of experience, currently working with Laravel. Eager to learn new technologies, languages and broaden my knowledge, as well as meet new people. Started out as a QA for two years after which I've decided to change my career path onto web development, so that I could integrate the two in order to have a more complete vision and approach to projects.</p>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="video--content">
                    <div class="bg-section">
                        <img src="https://media.licdn.com/dms/image/C5603AQHN7ksWYM1W6A/profile-displayphoto-shrink_800_800/0/1610913459314?e=1715817600&v=beta&t=SqxAsL27N7naEgnTenTDwtoPxjChYFjCs9VcooIOFE8" alt="Background" />
                    </div>
                </div>
            </div>
            <!-- .col-md-6 end -->
