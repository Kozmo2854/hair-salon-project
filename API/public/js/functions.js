    ...
    $('.category-filter').click(function (e) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                data = data.filter(row => row.title==="Sharp Shear");
                let text = ''
                for (const someData of data) {
                    text+=`
                        <div class="col-xs-12 col-sm-6 col-md-4 product-item">
                            <div class="product--img">
                                <img src="${someData['image']}"/>
                            ...
                            <div class="product--content">
                                <div class="product--title">
                                    <h3><a href="#">${someData['title']}</a></h3>
                                </div>
                                <!-- .product-title end -->
                                <div class="product--price">
                                    <span>$${someData['originalPrice']}</span>
                                </div>
                                <!-- .product-price end -->
                            </div>
                            <!-- .product-bio end -->
